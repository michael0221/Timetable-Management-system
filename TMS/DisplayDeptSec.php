...
if($username)
{
	...
	if(GetNumberOfClasses($AcadDeg)==$Classno)
	{
    	...
    	?>
			<div align="center" style="overflow:scroll;width:50%">
    			...
    			while($row=mysqli_fetch_row($result))
    			{
					...
					$resultd=mysqli_query($mysqli,"select SubCode from collegesubject where 
    		 							AcadYNo='$year' and 
    		 							UniversityCode='$uncode1' and 
    		 							CollegeCode='$CollegeCode1' and 
    		 							DeptNo='$DeptNo' and 
		...
		{	
			...
			$result=mysqli_query($mysqli,"select DeptNo,DeptName,AcadDegreeId from departments  where 

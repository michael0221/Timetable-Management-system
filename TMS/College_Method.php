...
<div align="center">
	...
	<table class="aaa" border="0" width="93%" id="table2" dir="rtl" height="221">
		...
		<p align="center">
		<img border="0" id="img6" src="College_files/CollegeLocation.jpg" height="22" width="110" alt="&#1605;&#1608;&#1602;&#1593; &#1575;&#1604;&#1603;&#1604;&#1610;&#1577;" fp-style="fp-btn: Simple Text 1; fp-font: Traditional Arabic; fp-font-style: Bold; fp-font-size: 16; fp-font-color-normal: #FFFFFF; fp-img-hover: 0; fp-img-press: 0; fp-preload: 0; fp-bgcolor: #5A74A0" fp-title="&#1605;&#1608;&#1602;&#1593; &#1575;&#1604;&#1603;&#1604;&#1610;&#1577;"></td>
		...
		<?php
			...
			$res=mysqli_query($mysqli,"select max(CollegeCode) from Colleges");
...
//
function DisplayLoginForm($year)
{
	$mysqli = new mysqli('localhost', 'TMS', 'TMS', 'managetime', '3306');
?>
...
<input name="T2" id="T2" size="14" tabindex="2" style="font-family: Times New Roman; color: #003366; font-size: 14pt; font-weight: bold; float:right" dir="rtl" type="password"></td>

</tr>

<tr>
<td width="35%" bordercolorlight="#9999FF" bordercolordark="#6600FF" bgcolor="#5A74A0" height="25" dir="ltr" align="center">
<img border="0" id="img82" src="header_files/AcadYearBut.jpg" height="24" width="120" alt="&#1575;&#1604;&#1593;&#1575;&#1605; &#1575;&#1604;&#1583;&#1585;&#1575;&#1587;&#1609;" fp-style="fp-btn: Simple Text 1; fp-font: Traditional Arabic; fp-font-style: Bold; fp-font-size: 18; fp-font-color-normal: #FFFFFF; fp-img-hover: 0; fp-img-press: 0; fp-preload: 0; fp-bgcolor: #5A74A0" fp-title="&#1575;&#1604;&#1593;&#1575;&#1605; &#1575;&#1604;&#1583;&#1585;&#1575;&#1587;&#1609;"></td>
...
//					$conn = db_connect();
					...
					$result332=mysqli_query($mysqli,$sql_query332);
			...
			?>
			  <tr>
				...
				<tr>
					...
					if($status == 1)
					{
						$result = mysqli_query($mysqli,"select distinct(CollegeCode),CollegeName from Colleges where 
				...
				<tr>
					...
					<tr>
					   <td height="28%" width="75%">
						...
						$maxres=mysqli_query($mysqli,"select max(AcadYNo) from acadyear");

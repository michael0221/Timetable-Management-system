...
function GetAllDeparts($uncode,$CollegeCode)
{
	...
	$mysqli = new mysqli('localhost', 'TMS', 'TMS', 'managetime', '3306');
	$result = mysqli_query($mysqli,"select DeptNo from Departments where 
...
{
	$mysqli = new mysqli('localhost', 'TMS', 'TMS', 'managetime', '3306');
	$result = mysqli_query($mysqli,"select distinct(CollegeCode) from usedby where 
...
function GetLabHours($univCode,$CollegeCode,$DeptNo,$AcadProgId,$Classno,$SemNo,$year)
{$mysqli = new mysqli('localhost', 'TMS', 'TMS', 'managetime', '3306');
	$MaxYear=GetMaxYear();
...
function GetManagLabHours($univCode,$CollegeCode,$DeptNo,$AcadProgId,$Classno,$SemNo,$year)
{
	$mysqli = new mysqli('localhost', 'TMS', 'TMS', 'managetime', '3306');
	$MaxYear=GetMaxYear();

  ...
  if($update==1)
	{
		...
		$res = mysqli_query($mysqli,"update CollegeSubject set SubName='$SubName',SubHour='$SubHour',SubTHour='$SubTHour',SubCode='$SubCode' where
									AcadYNo='$year' and
									UniversityCode='$uncode' and
									CollegeCode='$CollegeCode' and
									DeptNo='$DeptNo' and AcadDegreeId='$AcadDeg' and
		...
		if($res)
		{
			...
			if($SubLHour >0)
			{
				...
				{
					$res2 = mysqli_query($mysqli,"update CollegeSubject set SubName='$SubName',SubHour='$SubLHour' where
									AcadYNo='$year' and
									UniversityCode='$uncode' and
									CollegeCode='$CollegeCode' and
									DeptNo='$DeptNo' and AcadDegreeId='$AcadDeg' and
			...
			else
			{
				...
				$res2 = mysqli_query($mysqli,"delete from CollegeSubject where
									AcadYNo='$year' and
									UniversityCode='$uncode' and
									CollegeCode='$CollegeCode' and
									DeptNo='$DeptNo' and AcadDegreeId='$AcadDeg' and

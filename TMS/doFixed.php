...
//	$conn = db_connect();
	...
	else
	{
		...
		$result = mysqli_query($mysqli,"update managinglec set TeacherId='$CollTeacherName' where  TeacherId='$AssistTeacher' and 
		...
		if($result)
		{
			...
			$result2 = mysqli_query($mysqli,"update Teachers set TeacherNo='$CollTeacherName',TeacherName='$TName' where TeacherNo='$AssistTeacher' and 
									CollegeCode='$AssistCollege' and UniversityCode='$uncode1'");
